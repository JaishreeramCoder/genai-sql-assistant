...
#     # -------------------------
#     # Upload logic (CSV + Excel all sheets)
#     # -------------------------
#     if uploaded_files:
...
#     # Always refresh tables list dynamically
#     tables = fetch_tables()
...
#         col1, col2, col3 = st.columns([6, 32, 15])
...
#     # ✅ Connect to SQLite Cloud (instead of local SQLite file)
...
#         col1, col2, col3, col4 = st.columns([6, 70, 35, 20])
...
#         # ✅ New button → Go to SQLite Cloud dashboard
#         with col4:
#             st.link_button(
